...
from module import ImageConverter, TextReader  # Import required modules only
from module.story_teller import StoryTeller  # This will now import StoryTellerV4

ImagePathLike = Union[str, Path]


class ImageReaderPipelineV2(BaseModule):
    ...
    def run(
        ...
        **caption_kwargs: Any,
        ...
        lang_code : str
            语言代码（与 VideoReaderPipelineV2 含义一致）。
        caption_kwargs : Any
        ...
        script_text= self.story_teller.run(caption, output_language=lang_code)
