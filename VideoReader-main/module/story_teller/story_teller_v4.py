...
# 加载模型和分词器
class StoryTellerV4(BaseModule):
    """StoryTeller
    =======================
    ...
    def run(self, text: str, output_language: str, system_prompt: str = "你是一个有帮助的助手。", max_tokens: int = 8192) -> str:
        """
        运行故事生成器，返回生成的故事文本。
